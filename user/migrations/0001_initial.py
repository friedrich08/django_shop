# Generated by Django 5.1.6 on 2025-03-28 15:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.role')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('paymethod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.paymethod')),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.sale')),
            ],
        ),
        migrations.CreateModel(
            name='Bill',
